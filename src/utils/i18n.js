...
const t = {
  en: {
    ...
    sections: {
      ...
      contact:  { eyebrow: '04 / CONTACT', main: 'GET IN TOUCH', sub: 'TELEGRAM · GITHUB', desc: 'Open to fullstack and AI engineering work. Tap the floating models to reach me, or grab the CV from the About section.' },
    ...
    portfolio: {
      ...
      contact:   { eyebrow: '04 / CONTACT', title: 'GET IN TOUCH', subtitle: 'TELEGRAM · GITHUB', body: 'Open to fullstack and AI engineering work. Tap the floating models to reach me on Telegram or GitHub.', footer: 'CUBE FACE: LEFT' },
  ...
  ru: {
    ...
    sections: {
      ...
      contact:  { eyebrow: '04 / КОНТАКТ', main: 'НА СВЯЗИ', sub: 'TELEGRAM · GITHUB', desc: 'Открыт к фуллстек и AI-проектам. Нажмите на плавающие модели или скачайте резюме в разделе «О себе».' },
    ...
    portfolio: {
      ...
      contact:   { eyebrow: '04 / КОНТАКТ', title: 'НА СВЯЗИ', subtitle: 'TELEGRAM · GITHUB', body: 'Открыт к фуллстек и AI-проектам. Нажмите на плавающие модели — Telegram или GitHub.', footer: 'ГРАНЬ КУБА: ЛЕВО' },
